...
class UAnimMontage;
class USoundBase;
class UAbstractionCharacterMovement;
...
private:
	/** Pointer to character movement component */
	UAbstractionCharacterMovement* MovementComponent;

public:
	// Sets default values for this character's properties
	//AAbstractionCharacter();
	AAbstractionCharacter(const FObjectInitializer& ObjectInitializer);
...
public:
	...
	TSubclassOf<class AAbstractionProjectile> ProjectileClass;
